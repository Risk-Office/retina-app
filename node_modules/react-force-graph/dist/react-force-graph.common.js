...
var ForceGraphARKapsule = _interopDefault(require('3d-force-graph-ar'));
...
const ForceGraphVR = fromKapsule(ForceGraphVRKapsule, {
  ...
  'd3Force', 'd3ReheatSimulation', 'refresh']
});
...
const ForceGraph3D = fromKapsule(ForceGraph3DKapsule, {
  methodNames: [// bind methods
  'emitParticle', 'd3Force', 'd3ReheatSimulation', 'stopAnimation', 'pauseAnimation', 'resumeAnimation', 'cameraPosition', 'scene', 'camera', 'renderer', 'controls', 'refresh'],
...
const ForceGraph2D = fromKapsule(ForceGraph2DKapsule, {
  methodNames: [// bind methods
  'emitParticle', 'd3Force', 'd3ReheatSimulation', 'stopAnimation', 'pauseAnimation', 'resumeAnimation', 'centerAt', 'zoom']
});
